...
const CheckoutButton = ({onCheckout, disabled, isLoading} : Props) => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-[425px] md:min-w-[700px] bg-gray-50" aria-describedby={undefined}>
                <DialogTitle className="sr-only">Confirm Delivery Details</DialogTitle>
                <UserProfileForm 
